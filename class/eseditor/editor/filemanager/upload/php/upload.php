...
$groupid_upload = explode(",", $editorConfig['groupstoupload']);

$usergroup = RcxGroup::getByUser($rcxUser);

$upload = "false";
if (count(array_intersect($usergroup, $groupid_upload)) > 0 )
	$upload = "true";

// Check if this uploader has been enabled.
if ( !$Config['Enabled'] || $upload === 'false' || $Config['Enabled'] == 'false' )
