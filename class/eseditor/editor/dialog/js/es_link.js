...
window.onload = function()
{
	...
	GetE('divBrowseServer').style.display = oEditor.ESConfig.LinkBrowser ? '' : 'none' ;
...
{
	var aAnchors	= oEditor.ES.EditorDocument.anchors ;
...
function BrowseServer()
{
	...
	var iWidth	= oEditor.ESConfig.LinkBrowserWindowWidth ;
	var iHeight	= oEditor.ESConfig.LinkBrowserWindowHeight ;
	...
	var oWindow = window.open( oEditor.ESConfig.LinkBrowserURL, "ESBrowseWindow", sOptions ) ;
}
