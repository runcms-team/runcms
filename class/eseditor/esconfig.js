...
ESConfig.SkinPath = ESConfig.BasePath + 'skins/default/' ;
...
// ESConfig.ProtectedSource.Add( /<%[\s\S]*?%>/g ) ;	// ASP style server side code <%...%>
// ESConfig.ProtectedSource.Add( /<\?[\s\S]*?\?>/g ) ;	// PHP style server side code <?...?>
// ESConfig.ProtectedSource.Add( /(<asp:[^\>]+>[\s|\S]*?<\/asp:[^\>]+>)|(<asp:[^\>]+\/>)/gi ) ;	// ASP.Net style tags <asp:control>
ESConfig.AutoDetectLanguage	= true ;
ESConfig.DefaultLanguage		= 'en' ;
ESConfig.ContentLangDirection	= 'ltr' ;
ESConfig.EnableXHTML		= true ;	// Unsupported: Do not change.
ESConfig.EnableSourceXHTML	= true ;	// Unsupported: Do not change.
...
ESConfig.ToolbarSets["Basic"] = [
	['Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','-']
] ;
ESConfig.ContextMenu = ['Generic','Link','Anchor','Image','Flash','Select','Textarea','Checkbox','Radio','TextField','HiddenField','ImageButton','Button','BulletedList','NumberedList','TableCell','Table','Form'] ;
...
var _FileBrowserLanguage	= 'asp' ;	// asp | arcx | cfm | lasso | perl | php | py
var _QuickUploadLanguage	= 'asp' ;	// asp | arcx | cfm | lasso | php
// Don't care about the following line. It just calculates the correct connector 
// extension to use for the default File Browser (Perl uses "cgi").
var _FileBrowserExtension = _FileBrowserLanguage == 'perl' ? 'cgi' : _FileBrowserLanguage ;
ESConfig.LinkBrowser = true ;
...
ESConfig.ImageBrowser = true ;
ESConfig.ImageBrowserURL = ESConfig.BasePath + 'filemanager/browser/default/browser.html?Type=Image&Connector=connectors/' + _FileBrowserLanguage + '/connector.' + _FileBrowserExtension ;
...
ESConfig.ImageUpload = true ;
ESConfig.ImageUploadURL = ESConfig.BasePath + 'filemanager/upload/' + ESConfig.QuickUploadLanguage + '/upload.' + _QuickUploadLanguage + '?Type=Image' ;
...
ESConfig.SmileyPath	= ESConfig.BasePath + 'images/smiley/msn/' ;
ESConfig.SmileyImages	= ['regular_smile.gif','sad_smile.gif','wink_smile.gif','teeth_smile.gif','confused_smile.gif','tounge_smile.gif','embaressed_smile.gif','omg_smile.gif','whatchutalkingabout_smile.gif','angry_smile.gif','angel_smile.gif','shades_smile.gif','devil_smile.gif','cry_smile.gif','lightbulb.gif','thumbs_down.gif','thumbs_up.gif','heart.gif','broken_heart.gif','kiss.gif','envelope.gif'] ;
ESConfig.SmileyColumns = 8 ;
ESConfig.SmileyWindowWidth		= 320 ;
ESConfig.SmileyWindowHeight	= 240 ;
