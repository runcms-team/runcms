...
if (!defined("ERCX_RCXFORMTEXT_INCLUDED")) {
	define("ERCX_RCXFORMTEXT_INCLUDED", 1);

include_once(RCX_ROOT_PATH."/class/form/formelement.php");

class RcxFormText extends RcxFormElement {

	var $size;
	var $maxlength;
	var $value;

	function RcxFormText($caption, $name, $size, $maxlength, $value="") {
