...
include_once RCX_ROOT_PATH.'/language/'.$GLOBALS['rcxConfig']['language'].'/calendar.php';
?>
<link rel="stylesheet" type="text/css" media="all" href="<?php echo RCX_URL;?>/include/calendar-blue.css" />
<script type="text/javascript" src="<?php echo RCX_URL.'/include/calendar.js';?>"></script>
