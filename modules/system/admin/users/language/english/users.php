...
define("_AM_YMCACF","You must complete all compulsory fields");
...
define("_AM_INDICATECOF","* indicates compulsory fields");
...
define("_AM_BANNED","BAN user");
define("_AM_BANNED","Do you want to BAN user %s?");
define("_AM_BANUSER","This will remove permanently all info about user and then ad user Nickname, Email and IP to Ban Filter.");
define("_AM_HANDLES", "'Delete or Ban' ?? ");
define("_AM_AYSYWTDU","Do you want to delete user %s?");
define("_AM_MODIFYUSER","Modify");
