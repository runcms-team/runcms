...
define("_AM_BGROUPS","Belongs to group:");
...
define("_AM_DELUSER","Ban/Delete");
define("_AM_NOT_AUTORIZED_PM","Not authorized to use the PM");
define("_AM_RANGSTAT","User Rang / Status");

define("_AM_TIMEZONE","Time zone");
