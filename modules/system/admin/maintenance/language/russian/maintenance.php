...
define("_MI_MAINT_NAME","Закрыть/Открыть сайт");
define("_MI_MAINT_DESC","Модуль закрывает/открывает доступ на ваш сайт.");
define("_MI_MAINT_LICENSE","LGPL");
define("_MI_MAIN","Главная");
define("_MI_HELP","Помощь");
define("_AM_UPDATE","обновить");
define("_MI_SHOW_IN_BLOCK","Показать в блоке");
