...
define("_AM_MAILOK","Only to users that checked mail OK (optional)");
define("_AM_TOEMAILS","Comma delimited list of emails to send this message to (optional)");
define("_AM_RECIEPT","Require a valid Email reciept (email only)");
define("_AM_TYPE","Email type (email only)");
define("_AM_PRIORITY","Email priority level (email only)");
define("_AM_ATTACH","Attach file (email only)");
define("_AM_INLINE", "Inline");
