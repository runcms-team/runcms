...
define("_MB_FAQ_SHOW", "Показывать дату?");
define("_MB_FAQ_TRIM", "Урезать до:");
define("_MB_FAQ_LIMIT", "Предел:");
define("_MB_FAQ_TITLE", "Последние добавления в секцию ЧаВо(FAQ):");
?>