...
define("_AM_ANONSUBMIT","Allow anonymous users to submit articles?");
...
define("_AM_PAGEBREAK","* Seperate multiple pages by [PAGEBREAK]");


define("_AM_DISPLAYTWO","Two News Blocks side by side?");
define("_AM_DISPLAYFIRST","Show the first news block normally?");
