...
echo "<table><tr><td><form action='postcomment.php' method='post' id='commentform' onsubmit='return rcxValidate(\"subject\", \"message\", \"comment_submit\");'><br /><br /><b>". _YOURNAME .":</b>&nbsp;";

if ( $rcxUser ) {
  echo "<a href='".RCX_URL."/userinfo.php?uid=".$rcxUser->getVar("uid")."'>".$rcxUser->getVar("uname")."</a>&nbsp;[&nbsp;<a href='".RCX_URL."/user.php?op=logout'>"._LOGOUT."</a>&nbsp;]";
  } else {
    echo "<b>".$rcxConfig['anonymous']."</b>";
    echo " [ <a href='".RCX_URL."/register.php'>"._REGISTER."</a> ] ";
  }
...
echo "<input type='text' class='text' id='subject' name='subject' size='50' maxlength='60' value='$subject' /><br /><br /><b>". _MESSAGEICON ."</b><table><tr align='left'><td>";
...
while ( list ($key, $file) = each ($filelist) ) {
  ...
  echo "<img src='".RCX_URL."/images/subject/".$file."' border='0' alt='' />&nbsp;";
  if ( $count == 8 ) {
    echo "<br />";
    $count = 0;
  }
...
echo "</td></tr></table><br /><b>". _COMMENT ."</b><br /><br />";
