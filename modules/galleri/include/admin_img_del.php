...
*/
    if ( defined('GALL_ADMIN') ) {
          ...
          case "yes":
            ...
            global $db, $_POST, $gallts, $eh;
                ...
                if (!$result){
                    ...
                    redirect_header("index.php?op=img_conf&cid=".$cid, 1 ,_Selectedfile." ".$del_img->img()." "._deleted);
                }
          break;
        ...
        gall_cp_header();
            ...
            gall_function("yes_no_hidden", array ($text, GAL_ADMIN_URL."/index.php", array("name='op' value='delImg'", "name='op_pref' value='yes'", "name='img_id' value='".$img_id."'", "name='cid' value='".$cid."'"), "", _AD_MA_YES, GAL_ADMIN_URL."/index.php", array("name='op' value='img_conf'", "name='cid' value='".$cid."'"), "", _AD_MA_NO));
//            gall_function("yes_no_hidden", array ($text, GAL_ADMIN_URL."/index.php?op=delImg&op_pref=yes&img_id=".$img_id."&cid=".$cid, "", "", _AD_MA_YES, GAL_ADMIN_URL."/index.php", array("name='op' value='img_conf'", "name='cid' value='".$cid."'"), "", _AD_MA_NO));
        gall_cp_footer();
          break;
        }
    }
