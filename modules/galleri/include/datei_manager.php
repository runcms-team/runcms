...
// ALT tag
                        ...
                        $store_img->setVar("new_img", $new);
                            ...
                            if (!$store){
                                ...
                                echo "<center><a href='".GAL_ADMIN_URL."/index.php?op=img_conf&cid=".$cid."'>"._AD_MA_NEXT."</a></center>"; 
                            ...
                            gall_cp_header(); 
                            gall_function("admin_meldung_go_hidden", array(_ERROR_FONT._Errorup.": ".$result[$userfile]['basename']."<br>".$upload->errors()."</font>", GAL_ADMIN_URL."/index.php", array("name='op' value='img_conf'", "name='cid' value='".$cid."'"), "", _AD_MA_NEXT));
                          gall_cp_footer();
                            exit();
                        }
                    }
        ...
        echo "<br>";
		 ...
		 $retur_button = new RcxFormButton("Tilbage til hoved menu", "button", HOVEDMENU, "button");
