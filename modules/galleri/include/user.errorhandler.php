...
if(!defined("RCX_C_ERRORHANDLER_INCLUDED")){
    ...
    class ErrorHandler {
        function show($e_code, $form_action, $form_hidden=array(), $form_option="", $pages=1) {
    		...
    		$errmsg = array(
    			...
    			"0203" => _ADMIN_ERR_0203,
    			"0204" => _ADMIN_ERR_0204,
    			"1001" => "Bitte Titel eingeben !",
    			...
    			"9999" => "Sorry, für diesen Fehler ist noch keine Meldung vorhanden !"
    		);
